...
class JuegoBlocka {
    ...
    obtenerElementosDOM() {
        return {
            ...
            btnMenuTimeUp: document.getElementById('btnMenuTimeUp'),
    ...
    configurarEventListeners() {
        ...
        this.elementos.btnRetryLevel.addEventListener('click', () => this.reiniciarNivel());
        this.elementos.btnMenuTimeUp.addEventListener('click', () => this.irAlMenu());
    ...
    mostrarPantalla(nombre) {
        ...
        this.elementos.timeUpScreen.classList.add('hidden');
        ...
        } else if (nombre === 'tiempoAgotado') {
            this.elementos.timeUpScreen.classList.remove('hidden');
        }
    ...
    inicializarNivel() {
        if (!this.imagenSeleccionada) {
            console.error('No hay imagen seleccionada, volviendo al menú.');
            this.irAlMenu();
            return;
        }
        ...
        const onTick = (segundos) => {
            ...
            if (nivel.tiempoLimite && segundos >= nivel.tiempoLimite) {
                this.temporizador.detener();
                this.mostrarPantallaTiempoAgotado();
            }
        };
    ...
    mostrarPantallaTiempoAgotado() {
        this.mostrarPantalla('tiempoAgotado');
    }
